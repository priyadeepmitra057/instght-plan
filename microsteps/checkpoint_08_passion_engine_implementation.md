# CHECKPOINT 08: Passion Engine Implementation (Detector, Insight Gen)

Directly modified:   passion_detector.py, passion_insight_generator.py
Indirectly affected: Passion pipeline
Code blocks used:    CB-P4-01, CB-P4-02
Risk:                MEDIUM
Depends on:          CHECKPOINT 07
...
CONTEXT
Implementing the core detection and insight generation logic for the passion engine.

PRE-CONDITIONS
[ ] Checkpoint 07 passed.
...
STEPS
  ...
  Action:         CREATE
  Source file:    passion_plan_part4.md
  Source section: 15. passion_detector.py
  Block ID:       CB-P4-01
  Flags:          NONE
  ...
  Instruction: Create `passion_detector.py` with verbatim content.
...
def detect_passions(
  ...
  Rollback: Delete passion_detector.py.

  STEP [8.2]
  File:           passion_insight_generator.py
  Action:         CREATE
  Source file:    passion_plan_part4.md
  Source section: 16. passion_insight_generator.py
  Block ID:       CB-P4-02
  Flags:          NONE
  ...
  Instruction: Create `passion_insight_generator.py` with verbatim content.
...
def generate_passion_insights(
  ...
  Rollback: Delete passion_insight_generator.py.

POST-EXECUTION VALIDATION
[ ] `passion_detector.py` exists.
[ ] `passion_insight_generator.py` exists.
[ ] `python3 -m py_compile passion_detector.py passion_insight_generator.py` succeeds.

GO / NO-GO
All checks pass → proceed to CHECKPOINT [09]
